...
const fakerElementSchema = z.object({
...
const fakeElementSchema = z.object({
  type: z.literal('element'),
  name: z.string(),
  attributes: z.union([attributesSchema, z.undefined()]).optional(),
  children: z.array(
    z.union([fakerElementSchema, textSchema, commentSchema, instructionSchema, cDataSchema]),
  ),
})
...
export const elementSchema = z.object({
  ...
  attributes: z.union([attributesSchema, z.undefined()]).optional(),
  children: z.array(
    z.union([fakeElementSchema, textSchema, commentSchema, instructionSchema, cDataSchema]),
  ),
})
